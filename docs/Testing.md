...
*Rule of thumb: Skip testing simple CRUD, basic API wiring, and "dumb" UI components.*
...
*(Note: This file is a great reference for seeing the core concepts in one place before you start splitting them into folders.)*
