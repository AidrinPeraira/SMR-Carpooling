...
/**
 * This class implements a event dispatcher. It keeps track of the
 * event names and correspondig handler methods, which are registered
 * to it. It calls the right handler based on the event
 */
export class EventDispatcher implements IEventDispatcher {
   ...
   *
   * @param eventName : Routing key / name of the event
   * @param handler : Handler instance for the event
   */
  register(eventName: EventName, handler: IEventHandler): void {
   ...
   *
   * @param event : Full event object from broker
   */
